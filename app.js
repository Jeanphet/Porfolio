...
.pauseFor(1800)
.changeDelay(20)
.typeString('Je suis Jean Philippe LAPEYRERE')
.pauseFor(300)
.typeString('<strong>, Ingénieur Technique</strong> !')
.pauseFor(1000)
.deleteChars(11)
.typeString('<span style="color: #27ae60;"> Commercial</span> !')
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: #EA39ff;"> Energie</span> !')
.pauseFor(8)
.deleteChars(10)
.typeString('<span style="color: midnightblue;"> Fluides</span> !')
.pauseFor(1000)
.deleteChars(9)
.typeString('<span style="color: #ff6910;"> Climatisation</span> !')
.start()
